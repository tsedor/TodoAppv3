...
const TodoModal = ({ addTodo, addTodoValue, addTodoInputUpdate, toggleAddTodoModal, visibilityAddTodoModal }) => (
  <Modal open={visibilityAddTodoModal} size='tiny'>
    <Modal.Header>Dodaj zadanie</Modal.Header>
    <Modal.Content>
      <Input placeholder="Podaj treść" fluid onChange={e => addTodoInputUpdate(e.target.value)} value={addTodoValue} />
    </Modal.Content>
    <Modal.Actions>
